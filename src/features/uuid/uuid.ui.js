...
export class UuidUI {
    ...
    handleCountInput() {
        if (this.elements.uuidCountInput.value.trim() === "") {
            ...
            this.copyMultipleBtn.disabled = false;
        }
    }
