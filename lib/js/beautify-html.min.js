  ...
  !(function () {
    ...
    var i = [
        ...
        function (t, e, n) {
          ...
          (d.prototype.get_parser_token = function () {
            ...
            (g.prototype.beautify = function () {
              ...
              for (var a = null, o = r.next(); o.type !== u.EOF; )
          ...
          (g.prototype._get_tag_open_token = function (t) {
            ...
            return (
              ...
              (t.is_end_tag =
                t.is_end_tag || r(t.tag_check, this._options.void_elements)),
              (t.is_empty_element =
                t.tag_complete || (t.is_start_tag && t.is_end_tag)),
              (t.is_unformatted =
                !t.tag_complete && r(t.tag_check, this._options.unformatted)),
                  ...
                  ? ((e = !1),
                    (e =
                      ...
                      (!n.is_inline_element &&
                        ...
                        "TK_CONTENT" !== _.type)),
                    (e =
                      n.is_content_unformatted || n.is_unformatted ? !1 : e) &&
                      t.print_newline(!1))
        ...
        function (t, e, n) {
          ...
          ((s.prototype = new i())._is_comment = function (t) {
            return !1;
          }),
            ...
            (s.prototype._read_comment_or_cdata = function (t) {
              var e = null,
                n = null,
                i = null;
              return (
            ...
            (s.prototype._read_processing = function (t) {
              var e = null,
                n = null;
              return (
                "<" !== t ||
                  ((n =
                    "!" === (t = this._input.peek(1)) || "?" === t
                      ...
                      : n) &&
                    ((e = this._create_token(o.COMMENT, n)).directives = null)),
                e
              );
            }),
            (s.prototype._read_open = function (t, e) {
              var n = null,
                i = null;
              return (
                e ||
            ...
            (s.prototype._read_open_handlebars = function (t, e) {
              var n = null,
                i = null;
              return (
                e ||
                    ...
                    (i =
                      "!" === this._input.peek(2)
                        ? ((n =
                            ...
                            this.__patterns.handlebars.read()),
                          this._create_token(o.COMMENT, n))
                        : ((n = this.__patterns.handlebars_open.read()),
                          this._create_token(o.TAG_OPEN, n)))),
                i
              );
            }),
            (s.prototype._read_close = function (t, e) {
              var n = null,
                i = null;
              return (
                e &&
                  ...
                  (">" === t || ("/" === t && ">" === this._input.peek(1)))
                    ? ((n = this._input.next()),
                      ...
                      (i = this._create_token(o.TAG_CLOSE, n)))
                    : "{" === e.text[0] &&
                      "}" === t &&
                      "}" === this._input.peek(1) &&
                      (this._input.next(),
                      this._input.next(),
                      (i = this._create_token(o.TAG_CLOSE, "}}")))),
                i
              );
            }),
            (s.prototype._read_attribute = function (t, e, n) {
              var i,
                _ = null;
              return (
                n &&
                  "<" === n.text[0] &&
                  ("=" === t
                    ? (_ = this._create_token(o.EQUALS, this._input.next()))
                    : '"' === t || "'" === t
                    ? ((n = this._input.next()),
                      (n += (
                        '"' === t
                      ...
                      (_ = this._create_token(o.VALUE, n)))
                    : (i = this.__patterns.attribute.read()) &&
                      (_ =
                        e.type === o.EQUALS
                          ? this._create_token(o.VALUE, i)
                          : this._create_token(o.ATTRIBUTE, i))),
                _
              );
            }),
            (s.prototype._is_content_unformatted = function (t) {
              return (
            ...
            (s.prototype._read_raw_content = function (t, e, n) {
              var i = "";
              if (n && "{" === n.text[0])
                ...
                e = e.opened.text.substr(1).toLowerCase();
                if ("script" === e || "style" === e) {
                  t = this._read_comment_or_cdata(t);
            ...
            (s.prototype._read_content_word = function (t) {
              var e = "";
              if (
                (e =
                  (e =
