import { imageCheckerTemplate } from "./imageChecker.template.js";
import { ImageCheckerService } from "./imageChecker.service.js";
import { BaseUrlService } from "../html/html.baseurlservice.js";
...
export class ImageCheckerUI {
  ...
  showLoading() {
    this.elements.resultsContainer.innerHTML = '<div class="loading">Checking image...</div>';
  }

  showError(message) {
    this.elements.resultsContainer.innerHTML = `<div class="error-message">${message}</div>`;
  }
